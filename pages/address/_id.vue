    ...
    <div class="card section-card">
      ...
      <div class="card-body info-table">
        ...
        <div class="columns">
          ...
          <div class="column info-value monospace">
            ...
            <span v-if="unconfirmed !== '0' && staking !== '0'">
              ({{ unconfirmed | qtep }} QTEP {{ $t('address.unconfirmed') }},
              {{ staking | qtep }} QTEP {{ $t('address.staking') }})
            </span>
        ...
        <div class="columns">
          ...
          <div class="column info-value monospace">{{ totalReceived | qtep }} QTEP</div>
        </div>
        <div class="columns">
          <div class="column info-title">{{ $t('address.total_sent') }}</div>
          <div class="column info-value monospace">{{ totalSent | qtep }} QTEP</div>
        </div>
